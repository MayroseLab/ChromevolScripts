...
use constant FILENAME_PLOIDY_ERROR		=> "ploidy_inference_error.txt";
use constant FILENAME_MODEL_ADEQUACY_ERROR		=> "model_adequacy_error.txt";
use constant FILENAME_RUNTIME_ERROR		=> "taxa_input_report.txt";
